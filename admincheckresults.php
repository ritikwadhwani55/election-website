...
<title>Admin Check Results</title>
...
<ul>
  ...
  <li><a class="active">CHECK RESULTS</a></li>
...
<h2>BOYS CR</h2>
  <?php
    ...
    if($stmt = $conn->query("select s.student_id,p.post,p.no_of_votes,s.full_name from participant p inner join student s on p.student_id=s.student_id where s.gender='M' and s.division='".$_POST['class_fetch']."' and p.post='CR'")){
    ...
    if($stmt = $conn->query("select s.student_id,p.post,p.no_of_votes,s.full_name from participant p inner join student s on p.student_id=s.student_id where s.gender='F' and s.division='".$_POST['class_fetch']."' and p.post='CR'")){
    ...
    if($stmt = $conn->query("select s.student_id,p.post,p.no_of_votes,s.full_name from participant p inner join student s on p.student_id=s.student_id where s.gender='M' and s.division='".$_POST['class_fetch']."' and p.post='CI'")){
    ...
    if($stmt = $conn->query("select s.student_id,p.post,p.no_of_votes,s.full_name from participant p inner join student s on p.student_id=s.student_id where s.gender='F' and s.division='".$_POST['class_fetch']."' and p.post='CI'")){
    ...
    if($stmt = $conn->query("select s.student_id,p.post,p.no_of_votes,s.full_name from participant p inner join student s on p.student_id=s.student_id where s.gender='M' and s.division='".$_POST['class_fetch']."' and p.post='SORT'")){
    ...
    if($stmt = $conn->query("select s.student_id,p.post,p.no_of_votes,s.full_name from participant p inner join student s on p.student_id=s.student_id where s.gender='F' and s.division='".$_POST['class_fetch']."' and p.post='SORT'")){
    ...
    if($stmt = $conn->query("select s.student_id,p.post,p.no_of_votes,s.full_name from participant p inner join student s on p.student_id=s.student_id where s.gender='M' and s.division='".$_POST['class_fetch']."' and p.post='SPORTS'")){
    ...
    if($stmt = $conn->query("select s.student_id,p.post,p.no_of_votes,s.full_name from participant p inner join student s on p.student_id=s.student_id where s.gender='F' and s.division='".$_POST['class_fetch']."' and p.post='SPORTS'")){
