...
<?php  
  { 
              $query="select division from student where student_id=".$_SESSION['student_id'].";";
              ...
              // $p_id=$row[0][0];
              // echo var_dump($p_id);
              $query_pic="select p.profile_pic,p.img_name,p.img_type from student s inner join participant p on s.student_id=p.student_id where s.division="."'".(string)$class['division']."'"." and p.post='CR' and s.gender='M';";
              ...
              echo $op;
              echo "<h4>GIRLS CR</h4>";
              $sql_CR="select s.full_name,p.about,p.participant_id,p.profile_pic,p.img_name,p.img_type from student s inner join participant p on s.student_id=p.student_id where s.division="."'".(string)$class['division']."'"." and p.post='CR' and s.gender='F';";
...
<?php  
  { 
              $query_CI_BOY="select division from student where student_id=".$_SESSION['student_id'].";";
              ...
              for($i=0;$i<count($row_CI_BOY);$i++)
              {
                error_reporting(0);
                $p_id=$row_CI_BOY[$i][0];
                $op_CI_BOY.="<div class='card card-bg-light mt-4' style='width:300px'>
                <img src='images\young-man-face-cartoon-design-vector-9772843.jpg' class='.card-img-top mx-auto d:block' style='width:120px;height:140px;'><br> 
              ...
              echo $op_CI_BOY;
              echo "<h4>GIRLS CI</h4>";
              $sql_CI_GIRL="select s.full_name,p.about,p.participant_id,p.profile_pic,p.img_name,p.img_type from student s inner join participant p on s.student_id=p.student_id where s.division="."'".(string)$class['division']."'"." and p.post='CI' and s.gender='F';";
...
<?php  
  { 
              $query_SORT_BOY="select division from student where student_id=".$_SESSION['student_id'].";";
              $res_SORT_BOY=mysqli_query($conn, $query_SORT_BOY);
              $class=mysqli_fetch_assoc($res_SORT_BOY);
              $sql_SORT_BOY="select s.full_name,p.about,p.participant_id,p.profile_pic,p.img_name,p.img_type from student s inner join participant p on s.student_id=p.student_id where s.division="."'".(string)$class['division']."'"." and p.post='SORT' and s.gender='M';";
              $result_SORT_BOY=mysqli_query($conn,$sql_SORT_BOY);
              $row_SORT_BOY=mysqli_fetch_all($result_SORT_BOY);
              // $p_id=$row[0][0];
              // echo var_dump($p_id);
              $query_pic_SORT_BOY="select p.profile_pic,p.img_name,p.img_type from student s inner join participant p on s.student_id=p.student_id where s.division="."'".(string)$class['division']."'"." and p.post='SORT' and s.gender='M';";
              ...
              for($i=0;$i<count($row_SORT_BOY);$i++)
              {
                ...
                $op_SORT_BOY.="<div class='card card-bg-light mt-4' style='width:300px'>
                <img src='images\young-man-face-cartoon-design-vector-9772843.jpg' class='.card-img-top mx-auto d:block' style='width:120px;height:140px;'><br> 
              ...
              $sql_SORT_GIRL="select s.full_name,p.about,p.participant_id,p.profile_pic,p.img_name,p.img_type from student s inner join participant p on s.student_id=p.student_id where s.division="."'".(string)$class['division']."'"." and p.post='SORT' and s.gender='F';";
...
<?php  
  { 
              $query_SPORTS_BOY="select division from student where student_id=".$_SESSION['student_id'].";";
              $res_SPORTS_BOY=mysqli_query($conn, $query_SPORTS_BOY);
              $class=mysqli_fetch_assoc($res_SPORTS_BOY);
              // echo $class['division'];
              $sql_SPORTS_BOY="select s.full_name,p.about,p.participant_id,p.profile_pic,p.img_name,p.img_type from student s inner join participant p on s.student_id=p.student_id where s.division="."'".(string)$class['division']."'"." and p.post='SPORTS' and s.gender='M';";
              $result_SPORTS_BOY=mysqli_query($conn,$sql_SPORTS_BOY);
              $row_SPORTS_BOY=mysqli_fetch_all($result_SPORTS_BOY);
              // $p_id=$row[0][0];
              // echo var_dump($p_id);
              $query_pic_SPORTS_BOY="select p.profile_pic,p.img_name,p.img_type from student s inner join participant p on s.student_id=p.student_id where s.division="."'".(string)$class['division']."'"." and p.post='SPORTS' and s.gender='M';";
              ...
              for($i=0;$i<count($row_SPORTS_BOY);$i++)
              {
                ...
                $op_SPORTS_BOY.="<div class='card card-bg-light mt-4' style='width:300px'>
                <img src='images\young-man-face-cartoon-design-vector-9772843.jpg' class='.card-img-top mx-auto d:block' style='width:120px;height:140px;'><br> 
              ...
              $sql_SPORTS_GIRL="select s.full_name,p.about,p.participant_id,p.profile_pic,p.img_name,p.img_type from student s inner join participant p on s.student_id=p.student_id where s.division="."'".(string)$class['division']."'"." and p.post='SPORTS' and s.gender='F';";
...
<?php
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
      ...
      $answer=mysqli_fetch_assoc($result1);
      ...
      {
        // strtotime($row['date_id'])==strtotime($answer['curdate()'])
        ...
        if(!$voted['has_voted'])
        {
            ...
            if($c==count($participants))
            {
              ...
              // $q="SELECT s.student_id from student s inner join participant p on p.student_id=s.student_id where p.participant_id=".$_SESSION['participant_id'];
                      // $res=mysqli_query($conn,$q);
                      // $row=mysqli_fetch_assoc($res); 
                      $query1="update student set has_voted=1 where student_id=".$_SESSION['student_id'];
                      $ans=mysqli_query($conn,$query1);
                      if($check=mysqli_affected_rows($conn))
                      {
                        echo "<script>alert('Your vote is added!');</script>";
                        echo "<script>window.location.href='http://localhost:8080/ritik/election%20website/student.php';</script>";
                      }
                      else
                      {
            ...
            echo $c." ".count($participants)." ".$_SESSION['student_id'];
          }
        else
        {
