...
<title>Representative results</title>
...
<h2>BOYS CR</h2>
  <?php
      $sql_query="select s.division from participant p inner join student s on s.student_id=p.student_id where s.email_id='".$_SESSION['email']."' and s.password='".$_SESSION['password']."';";
